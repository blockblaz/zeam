...
const TestContext = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, num_validators: usize) !TestContext {
        ...
        for (0..num_validators) |i| {
            var att_pubkey: utils.Bytes52 = undefined;
            var prop_pubkey: utils.Bytes52 = undefined;
            _ = try key_manager.getAttestationPubkeyBytes(@intCast(i), &att_pubkey);
            _ = try key_manager.getProposalPubkeyBytes(@intCast(i), &prop_pubkey);
