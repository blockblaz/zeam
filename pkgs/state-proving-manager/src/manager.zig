...
pub fn prove_transition(state: types.BeamState, block: types.SignedBlockWithAttestations, opts: ZKStateTransitionOpts, allocator: Allocator) !types.BeamSTFProof {
