...
pub fn prove_transition(state: types.BeamState, block: types.SignedBlockWithAttestation, opts: ZKStateTransitionOpts, allocator: Allocator) !types.BeamSTFProof {
