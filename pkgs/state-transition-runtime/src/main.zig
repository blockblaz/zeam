...
var zeam_logger = zeam_utils.getLogger(null, null);
const logger = zeam_logger.child(.state_transition_runtime);
...
export fn main() noreturn {
    ...
    state_transition.apply_transition(allocator, &prover_input.state, prover_input.block, .{ .logger = &zeam_logger, .child_logger = logger }) catch |e| {
