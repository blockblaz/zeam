...
pub fn build(b: *Builder) !void {
    ...
    // add rocksdb — always build with ReleaseSmall to minimize archive size and avoid
    // LLD UnableToWriteArchive on Linux CI runners (the archive exceeds LLD's size limits)
